...
sequenceDiagram
    ...
    Guardian->>Guardian: Require active session then verify cert, then replay the last signed withdrawal's signatures or consume limiter tokens and sign BTC inputs

...
deploys use `None` and do not pass the flag.
...
sequenceDiagram
    ...
    Guardian->>Guardian: Require active session then verify cert, then sign BTC inputs, consuming limiter tokens unless this transaction is already logged as debited

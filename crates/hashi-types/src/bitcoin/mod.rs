...
pub use taproot::CheckedSpend;
pub use taproot::SIGHASH_TYPE_DEFAULT;
pub use taproot::SpendRecordError;
pub use taproot::check_spend_record;
pub use taproot::checked_spend_sighashes;
pub use taproot::sighash_digest;
pub use taproot::signing_key_x;
pub use taproot::signs_under_leaf_key;
pub use taproot::taproot_2of2_spend_data;

...
use crate::bls::HashiBLS12381PrivateKey;

#[derive(Clone, Debug, Default, serde_derive::Deserialize, serde_derive::Serialize)]
#[serde(rename_all = "kebab-case")]
pub struct Config {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub protocol_private_key: Option<HashiBLS12381PrivateKey>,
...
impl Config {
    ...
    pub fn protocol_private_key(&self) -> Option<HashiBLS12381PrivateKey> {

...
- `genesis` is a fixed singleton record carrying the first-deploy committee plus the exact KP-signed PI submissions that authorized it, before any `committee-update/` success exists.

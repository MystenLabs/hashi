...
//
// Renders a "beta feature" admonition; driven by the `beta` frontmatter key
// (see src/shared/plugins/betatag/index.js).

import React from "react";
import Admonition from "@theme/Admonition";

export default function BetaTag(props: { beta?: string; slim?: boolean }) {
  if (!props.beta) {
    return null;
  }
  ...
  return (
    ...
    >
      <p className="pt-2">
        This content describes an alpha/beta feature or service. These
        early-stage features and services are in active development, so details

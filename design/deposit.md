...
After confirmation, each committee member independently screens the deposit
(see [Handling Sanctioned Addresses](sanctions.mdx)). A member that rejects
the deposit does not vote to approve it.

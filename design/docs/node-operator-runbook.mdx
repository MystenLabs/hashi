...
|-----------|----------|--------|
| `hashi_reconfig_in_progress == 1` for > 10 min | Critical | Check logs for DKG/rotation errors. Once the reconfiguration has overrun its Sui epoch, `hashi committee abort-reconfig` clears it (section 9.3). |

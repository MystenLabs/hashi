---
title: Hashi Key Share Backups
description: How node operators encrypt and back up their MPC key shares using age, with optional YubiKey-based key generation.
keywords: [ key share, backup, age, YubiKey, encryption ]
---

...
6. Generate the PGP key on the YubiKey. You will be prompted to enter both the
   new user and new admin PINs. The public key will be saved to the output file.
...
7. Repeat the above steps for any additional YubiKeys.

8. Store the YubiKeys in a secure location, such as a company safe. Also save
...
4. Save the revocation, public key, and private key files in a secure location.
